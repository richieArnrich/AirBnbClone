 ...
 * Perks component
 *
 * A React component that renders a list of perks with checkboxes and icons.
 *
 * Props:
 * - selected: The currently selected perks
 * - onChange: A function to handle changes to the selected perks
 *
 * Returns:
 * A JSX element containing a list of perk labels with checkboxes and icons.
 */
import React from "react";
/**
 * Perks function component
 *
 * @param {object} props - Component props
 * @param {array} props.selected - The currently selected perks
 * @param {function} props.onChange - A function to handle changes to the selected perks
 *
 * @returns {JSX.Element} A JSX element containing a list of perk labels with checkboxes and icons.
 */
  ...
  return (
    <>
      ...
      <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
        ...
        />
        {/* Private Entrance icon SVG path */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
